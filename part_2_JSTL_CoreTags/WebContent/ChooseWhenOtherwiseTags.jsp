...
<html>
	<head>
		...
		<title>Customer table with enhanced conditional tests</title>
	</head>
		...
		<table border="1">
			...
			<c:forEach var="cust" items="${customers}">
				<tr>
					...
					<!-- using the choose, when & otherwise tags for enhanced conditional tests -->
					<td>
						<c:choose>
							<c:when test="${cust.vip}"> Special Discount </c:when>
